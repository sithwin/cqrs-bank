...
import com.techbank.account.cmd.command.DepositFundsCommand;
...
public class DepositFundsController {
  ...
  public ResponseEntity<BaseResponse> depositFunds(@PathVariable(value = "id") String id,
    ...
    try {
      ...
      var safeErrorMessage = MessageFormat.format("Error while processing to deposit funds to bank account with id - {0}", id);
